...
namespace AccountedOfFamily.Migrations
{
    ...
    [Migration("20220427074954_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountedOfFamily.Models.Identity.WCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AccountedOfFamily.Models.Identity.WaitingTransaction", b =>
                {
                    ...
                    b.HasOne("AccountedOfFamily.Models.Identity.WCategory", "WCategory")
                        .WithMany("WaitingTransactions")
                        .HasForeignKey("WCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WCategory");
                });
